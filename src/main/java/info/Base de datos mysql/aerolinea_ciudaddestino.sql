...
CREATE TABLE `ciudaddestino` (
  `idciudaddestino` int NOT NULL AUTO_INCREMENT,
  `nombre` varchar(45) COLLATE utf8_spanish_ci NOT NULL,
  `visa` varchar(30) COLLATE utf8_spanish_ci DEFAULT NULL,
...
INSERT INTO `ciudaddestino` VALUES (1,'Pereira',NULL),(2,'Cali',NULL),(3,'Medellin',NULL),(4,'Bogota',NULL);
...
-- Dump completed on 2021-12-13 14:58:19
