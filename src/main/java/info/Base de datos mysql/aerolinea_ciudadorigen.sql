...
CREATE TABLE `ciudadorigen` (
  ...
  `nombreorigen` varchar(46) COLLATE utf8_spanish_ci NOT NULL,
...
INSERT INTO `ciudadorigen` VALUES (1,'Bogota'),(2,'Cali'),(3,'Santa marta'),(4,'Barranquilla');
...
-- Dump completed on 2021-12-13 14:58:20
